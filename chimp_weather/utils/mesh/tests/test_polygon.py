...
from chimp_weather.utils.mesh.polygon import Polygon, Rectangle, Point
...
class PolygonTestCase(unittest.TestCase):
    ...
    def test_check_integrity(self):
        ...
        self.assertRaises(ValueError, Polygon._check_integrity, points+[Point(0,0)])
    ...
    def test_polygon(self):
        points = [Point(0,0), Point(10,0), Point(15, -1), Point(15, 20)]
        p = Polygon(points)
    ...
    def test_serialization(self):
        points = [Point(0,0), Point(-10.1325,0.0), Point(15.23, -1), Point(0.15, -0.20)]
